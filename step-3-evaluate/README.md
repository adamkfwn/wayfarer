...
Thresholds: disposition match and severity match at least 0.9. The script exits non-zero if either is missed, so it can gate a pipeline.
...
- [ ] Disposition match and severity match are at least 0.9, or you can explain each miss
